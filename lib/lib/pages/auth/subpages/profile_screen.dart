  ...
  return Column(
        children: [
          _buildDropDown<int?>(List.generate(120, (val) => 18 +val),
           user.age, viewModel.ageStream, viewModel.onAgeChanged, "years old" ),
          _buildDropDown<int?>(List.generate(72, (val) => 24 +val), user.height, viewModel.heigtStream, viewModel.onHeightChanged, "inches tall"),
          _buildDropDown<int?>(List.generate(450, (val) => 50 +val), user.weight, viewModel.weightStream, viewModel.onWeightChanged, "lbs Current Weight"),
          _buildDropDown<int?>(List.generate(450, (val) => 50 +val), user.targetBodyWeight, viewModel.targetStream, viewModel.onTargetChanged, "lbs Target Body Weight")
        ],
      );
  }
